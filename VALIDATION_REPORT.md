# PartsBridge AD 0.3.5 验证说明

验证日期：2026-08-28。环境：Windows 11 x64、Python 3.12.10、PyInstaller 6.22.2。
...
- **尚未验证**：在同权限 AD 会话中执行 0.3.5 实际追加、生成脚本、新 PCB 枚举器回读、临时文档行为、Components 面板即时显示效果。当前普通权限进程与管理员 AD 不匹配，未绕过权限门控；Windows 权限门控、生成脚本结构检查和单元测试不等于这些实际效果已通过。
